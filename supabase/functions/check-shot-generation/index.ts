// Reel Studio Phase B, stage 2 of 2: polls Higgsfield for exactly ONE
// submitted/rendering video_shots row (the DoP image-to-video request
// submitted by submit-shot-generation once the still frame -- stage 1,
// submit-shot-still-image/check-shot-still-image -- is complete). On
// completion, downloads the clip into our own video-assets bucket
// (Higgsfield retains files a minimum of 7 days only -- never rely on their
// CDN URL long-term) and marks the shot complete.
//
