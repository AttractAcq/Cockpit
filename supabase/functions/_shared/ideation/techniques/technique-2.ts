...
const definition = ideationTechniqueDefinition("review-mined-pain-language");

export const runTechnique2: TechniqueModule = (authority) => authorityResearch(authority, {
