...
import type {
  ClientWorkItemRow, WorkItemStatus, ClientOnboardingTemplateRow,
...
// CostMarginSection (+ CsvImportSection, FinancePeriodsSection) moved to
// src/components/finance/ in Cockpit v3 Step 2 so the top-level Finance page
// can share it -- see the import above.
