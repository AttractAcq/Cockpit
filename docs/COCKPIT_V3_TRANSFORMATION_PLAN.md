...
**Not yet done:** Finance's dashboard (step 3) hasn't been started. Verified: typecheck, lint (0 errors, same 6 pre-existing warnings), build, `check:edge-functions` (unaffected — 0 new edge functions), full suite 1095/1095 (14 new, 1 repointed), `git diff --check` clean.
